...
# я знаю что таким импортом лучше не пользоваться но мне показалось что в рамках этого задания это допустимо
# мне не захотелось менять имена всех переменных и  я захотел вот так сделать
